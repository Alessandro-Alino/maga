...
mixin _$ImageState {
 ...
 ImageStatus get status; ManageImageStatus get manageStatus; List<ImageModel> get fetchedImageList; List<ImageModel> get filterImageList; int get totalImage; int get pages; int get currentPage; ImageModel? get selectedImage; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,manageStatus,const DeepCollectionEquality().hash(fetchedImageList),const DeepCollectionEquality().hash(filterImageList),totalImage,pages,currentPage,selectedImage,errorMessage);

@override
String toString() {
  return 'ImageState(status: $status, manageStatus: $manageStatus, fetchedImageList: $fetchedImageList, filterImageList: $filterImageList, totalImage: $totalImage, pages: $pages, currentPage: $currentPage, selectedImage: $selectedImage, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 ImageStatus status, ManageImageStatus manageStatus, List<ImageModel> fetchedImageList, List<ImageModel> filterImageList, int totalImage, int pages, int currentPage, ImageModel? selectedImage, String? errorMessage
});
...
/// Create a copy of ImageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? manageStatus = null,Object? fetchedImageList = null,Object? filterImageList = null,Object? totalImage = null,Object? pages = null,Object? currentPage = null,Object? selectedImage = freezed,Object? errorMessage = freezed,}) {
...
as ImageModel?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of ImageState
...
class _ImageState implements ImageState {
  const _ImageState({required this.status, required this.manageStatus, required final  List<ImageModel> fetchedImageList, required final  List<ImageModel> filterImageList, required this.totalImage, required this.pages, required this.currentPage, this.selectedImage, this.errorMessage}): _fetchedImageList = fetchedImageList,_filterImageList = filterImageList;
...
@override
int get hashCode => Object.hash(runtimeType,status,manageStatus,const DeepCollectionEquality().hash(_fetchedImageList),const DeepCollectionEquality().hash(_filterImageList),totalImage,pages,currentPage,selectedImage,errorMessage);
...
/// Create a copy of ImageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? manageStatus = null,Object? fetchedImageList = null,Object? filterImageList = null,Object? totalImage = null,Object? pages = null,Object? currentPage = null,Object? selectedImage = freezed,Object? errorMessage = freezed,}) {
